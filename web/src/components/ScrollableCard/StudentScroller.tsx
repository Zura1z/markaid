...
export function StudentScroller() {
  ...
  return (
    <>
    <SCard style={{ width: "28rem", backgroundColor: "#b6acd1" ,borderColor:"white"}}>
      {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
      <Card.Body>
        <Card.Title style={{ color: "#4e2a84" ,textAlign:"center",fontWeight:"bold",fontSize:"30px"}}>Students</Card.Title>
...
export function CourseInfo(props: CourseCardProps) {
  return (
    <div className="card" style={{borderColor:"white",backgroundColor:"white"}}>
